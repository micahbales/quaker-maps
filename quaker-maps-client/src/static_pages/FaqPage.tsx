...
export const FaqPage: React.FC = () => (
    <div style={{ padding: '25px' }}>
        ...
        <p>It was either an oversight, or we were unable to find your information online. If your meeting is missing, please contact us and provide basic information on your Meeting or worship group.</p>

        <h2>Why isn’t my Yearly Meeting listed on Quakermaps.com?</h2>
        
        <p>At the present time, Quakermaps.com includes all of the Yearly Meetings that we are aware of in North America. Our ultimate goal is total coverage. However, there are a lot of technical hurdles standing in the way of this - mostly a lack of publicly available information. If you have that information and would like to help us get your Yearly Meeting listed, get in touch!</p>
        ...
        <p>Please contact us and let us know how we can enhance or correct our listing! It&apos;s most helpful if you can point to a church/meeting website where we can verify the details you send us.</p>
